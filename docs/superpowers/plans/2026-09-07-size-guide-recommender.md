...
4. กรอก ชาย / 33 / 165 / 80 แล้วกด → ขึ้น "ไซซ์ที่แนะนำ: XL"
   (ยืนยันด้วยการเรียก `recommend()` ตรง ๆ แล้ว — สเกล OVERBEAR เริ่มที่ XL ไม่ใช่ XS
   ร่างนี้จึงตกไซซ์เล็กสุด ไม่ใช่ 3XL อย่างที่ฉบับร่างแรกของแผนเขียนไว้ผิด)
...
Run: `npm run dev` แล้วกรอก ชาย / 33 / **172** / **110** → กด "ดำเนินการต่อ"

ค่าที่คาดไว้ยืนยันด้วยการเรียก `recommend()` ตรง ๆ แล้ว: ได้ **3XL** ·
ไหล่ พอดี (0) · รอบอก พอดี (−0.7) · ความยาวตัว หลวมเล็กน้อย (+4.5)
(เลือกร่างนี้เพราะอยู่กลางสเกล จึงกดแท็บได้ทั้งสองทาง และมีมิติที่ไม่ใช่ "พอดี" ให้ทดสอบสี)

ต้องเห็นครบ:
1. แถบโปรไฟล์ขึ้น "ชาย, 33 ปี, 172 ซม., 110 กก." พร้อมปุ่ม "เปลี่ยน"
...
Run: `npm run dev` แล้วกรอก ชาย / 33 / **172** / **110** (ได้ 3XL — ไหล่ พอดี · รอบอก พอดี · ความยาวตัว หลวมเล็กน้อย)
...
2. กดไล่แท็บ XL → 5XL แล้ว**สีของเส้นเปลี่ยนตามคำตัดสิน** (ดำ = พอดี, น้ำตาล = หลวม, แดง = คับ)
   ที่ร่างนี้ 3XL ต้องเห็นเส้นชายเสื้อเป็นน้ำตาลขณะที่ไหล่กับอกยังดำ — ถ้าทั้ง 3 เส้นสีเดียวกันหมด
   แปลว่าการแมปสีไม่ทำงาน
